...
constant CmdDispatcherSequencePorts = 14   # 6 UART connections, 1 RTT, 6 sequencers, 1 DPCE
...
@ Driven by SequenceArgumentsMaxSize & FW_CMD_ARG_BUFFER_MAX_SIZE
constant FileNameStringSize = 54
