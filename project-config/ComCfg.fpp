...
module ComCfg {
    ...
    dictionary constant SpacecraftId = 0x01AD
    ...
    dictionary enum Apid : FwPacketDescriptorType {
        ...
        FW_PACKET_HAND           = 0xF1  @< F Prime handshake
        FW_PACKET_UNKNOWN        = 0xFF  @< F Prime unknown packet
        INVALID_UNINITIALIZED    = 0xFE  @< F Prime unknown packet
    ...
    struct FrameContext {
        ...
        apid: Apid                  @< 1 byte packet type ID for UART
