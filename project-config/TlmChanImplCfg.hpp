...
#ifdef BUILD_UT
    // Needs to be boosted to 47 to fix TlmLinearChan UT
    // FIXME: See https://github.com/fprime-community/fprime-baremetal/issues/8
    TLMCHAN_HASH_BUCKETS = 47,
#else
    TLMCHAN_HASH_BUCKETS = 80,  // !< Buckets assignable to a hash slot.
