...
TLM_GDS_CHAN_CONFIG_FILE = "lib/fprime-vorago/default/config-vorago/TlmGdsChanCfg.fpp"
...
def get_type_size(
    ...
    type_obj: typing.Optional[typing.Any] = None,
) -> int:
    """
    ...
    if name is not None:
        ...
        type_obj = dictionary.typedefs_name[name]()
    if type_obj is None:
...
def validate_tlm_gds_chan_config(
    ...
    if buffer_size < total_size:
        sys.exit(
            ...
            f"channels require a buffer size of at least {total_size} bytes, increase the value "
            f"of {buffer_size_constant} in {TLM_GDS_CHAN_CONFIG_FILE} and retry"
        )
